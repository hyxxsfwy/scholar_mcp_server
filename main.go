...
func runHTTPServer(port string) {
	...
	log.Printf("[INFO] 支持的数据源: arXiv, Semantic Scholar, Crossref, Scopus, ADSABS, Google Scholar(SerpAPI), Sci-Hub")
